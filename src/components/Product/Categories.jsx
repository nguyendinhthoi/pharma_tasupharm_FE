...
function Categories() {
    ...
    const getAllProductByCategory = async () => {
        try {
            const res = await productService.getAllProductByCategory(idCategory, currentPage ,value,choose);
            if (res.status === 200) {
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 mb-0" id="targetDiv">
                            ...
                            {listProductByCategory[0]?.nameCategory && (
                                <>
                                    <span className="mx-2 mb-0">/</span>
                                    <strong className="text-black">{listProductByCategory[0].nameCategory}</strong>
                                </>
                            )}
                        </div>
                    </div>
